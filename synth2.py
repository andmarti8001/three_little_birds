...
bank_scales['a'] = [64, 66, 67, 69, 71, 72, 74]      # E Aeolian (E F# G A B C D)
bank_scales['w'] = [67, 69, 70, 72, 74, 75, 77]      # G Aeolian (G A Bb C D Eb F)
bank_scales['s'] = [67, 69, 71, 72, 74, 76, 78]      # G Ionian (G A B C D E F#)
bank_scales['e'] = [60, 62, 64, 65, 67, 69, 70]      # C Mixolydian (C D E F G A Bb)
bank_scales['d'] = [59, 61, 62, 65, 67, 68, 71]      # B Harmonic Minor (B C# D E F# G A#)
bank_scales['r'] = [60, 62, 63, 65, 67, 69, 71]      # C Melodic Minor (C D Eb F G A B)
bank_scales['f'] = [59, 60, 62, 65, 67, 68, 70]      # B Phrygian (B C D E F# G A)
